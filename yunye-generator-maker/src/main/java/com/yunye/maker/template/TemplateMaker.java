...
public class TemplateMaker {
    ...
    private static long makeTemplate(Meta newMeta, String originProjectPath, TemplateMakerFileConfig templateMakerFileConfig, TemplateMakerModelConfig templateMakerModelConfig, Long id) {
        ...
        if (modelGroupConfig != null) {
            ...
            Meta.ModelConfigDTO.ModelsDTO modelsDTO = new Meta.ModelConfigDTO.ModelsDTO();
            modelsDTO.setCondition(condition);
            modelsDTO.setGroupKey(groupKey);
            modelsDTO.setGroupName(groupName);
            //文件全放在一个分组内
        ...
        for (TemplateMakerFileConfig.FileInfoConfig fileInfoConfig : fileInfoConfigList) {
            ...
            for (File file : fileList) {
                Meta.FileConfigDTO.FilesDTO filesDTO = makeFileTemplate(file, templateMakerModelConfig, sourceRootPath);
     ...
     * @return
     */
    private static Meta.FileConfigDTO.FilesDTO makeFileTemplate(File fileInput, TemplateMakerModelConfig templateMakerModelConfig, String sourceRootPath) {
...
//        String str = "Sum";
        ...
        TemplateMaker.makeTemplate(meta, originProjectPath, templateMakerFileConfig,templateMakerModelConfig, 1773909827003686912L);
    }
    ...
    private static List<Meta.FileConfigDTO.FilesDTO> distinctFiles(List<Meta.FileConfigDTO.FilesDTO> filesDTOList) {
        ...
        for (Map.Entry<String, List<Meta.FileConfigDTO.FilesDTO>> stringListEntry : groupKeyFileInfoListMap.entrySet()) {
            ...
            List<Meta.FileConfigDTO.FilesDTO> newFileInfoList = new ArrayList<>(tempFileInfoList.stream()
                    ...
                    .collect(Collectors.toMap(Meta.FileConfigDTO.FilesDTO::getInputPath, o -> o, (e, r) -> r))
                    .values());
            //使用新的group配置
